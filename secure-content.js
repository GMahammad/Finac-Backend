    ...
    if (result.authenticated) {
        ...
        const observeUrlChanges = () => {
            ...
            const handleUrlChange = () => {
                ...
                if (currentUrl && currentUrl.includes('https://new.e-taxes.gov.az/eportal/invoice')) {
                    startObservingInvoice();
                }
                 if (currentUrl && currentUrl.includes('https://new.e-taxes.gov.az/eportal/declarations')) {
        ...
        function eqfInitializer(container) {
            ...
            btnFetchTax.addEventListener('click', async () => {
                const taxLinks = document.querySelectorAll('a[href^="/eportal/invoice/view/"]');
